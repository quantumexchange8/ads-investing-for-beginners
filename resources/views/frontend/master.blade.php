...
<body>
  ...
  <!--<header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">Investment for Beginners</a></h1>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          <h1>Growth Your Wealth <br> with Investment</h1>
          <h6 class="text-light">Investing involves committing money in order to earn a financial return. This essentially means that you invest money to make money and achieve your financial goals.</h6>
          <div class="d-flex justify-content-center justify-content-lg-start">
            <a href="https://www.youtube.com/embed/u4Adtp04JxI?si=n1ZzzdXxTQUdKbwN" class="glightbox btn-watch-video"><i class="bi bi-play-circle"></i>Watch Video</a>
...
<ol class="content pt-2" >
    ...
    </section><!-- End Type Investment Section -->
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-7 justify-content-center mt-5 mt-lg-0 d-flex align-items-stretch">
            <form method="POST"onsubmit="this.submit(); this.reset(); return false;" name="contact-form" action="https://sheetdb.io/api/v1/vktjbmdq0a1ub" role="form" id="sheetdb-form" class="php-email-form">
              <div class="row">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="data[description]" rows="10" required></textarea>
              </div>
